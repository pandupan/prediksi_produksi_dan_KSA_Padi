...
// Data untuk setiap fase pertumbuhan padi
// URL gambar di bawah ini adalah contoh, sesuaikan dengan URL gambar Anda
...
const SiklusTumbuhPadi = () => {
  ...
  return (
    <section id="siklus-padi" className="py-20 bg-gray-50">
      <motion.div
