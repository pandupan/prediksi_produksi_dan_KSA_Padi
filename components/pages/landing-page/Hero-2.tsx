...
const Hero2: React.FC<Hero2Props> = ({ heading, message }) => {
  ...
  return (
    <section id="hero2">
      <div className="relative flex w-full items-center h-[100vh] mb-[10rem] bg-fixed bg-center bg-cover hero-img-2">
        {/* Overlayer */}
