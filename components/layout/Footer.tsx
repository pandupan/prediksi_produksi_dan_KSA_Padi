        ...
        <hr className="my-6 border-gray-200 sm:mx-auto lg:my-8" />
          <div className="w-full h-auto px-4 py-6 lg:pt-8">
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center">© 2025 <a href="https://flowbite.com/" className="hover:underline"> Badan Pusat Statistik Tasikmalaya</a>. All Rights Reserved.
                </span>
